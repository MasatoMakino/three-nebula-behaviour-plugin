...
/******/ 	deferredModules.push(["./demoSrc/demoImageColor.js","vendor"]);
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"GradientColor\", function() { return GradientColor; });\n/* harmony import */ var three_nebula_src_behaviour_Behaviour__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! three-nebula/src/behaviour/Behaviour */ \"./node_modules/three-nebula/src/behaviour/Behaviour.js\");\n/* harmony import */ var three_nebula_src_core_constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! three-nebula/src/core/constants */ \"./node_modules/three-nebula/src/core/constants.js\");\n/* harmony import */ var three_nebula_src_ease__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! three-nebula/src/ease */ \"./node_modules/three-nebula/src/ease/index.js\");\n/* harmony import */ var _ColorCanvas__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ColorCanvas */ \"./esm/ColorCanvas.js\");\n\n\n\n\nclass GradientColor extends three_nebula_src_behaviour_Behaviour__WEBPACK_IMPORTED_MODULE_0__[\"default\"] {\n  constructor(colors, life, easing, isEnabled = true) {\n    super(life, easing, GradientColor.TYPE, isEnabled);\n    this.reset(colors);\n  } //TODO Plugin can not insert Behaviour Type Constant.\n\n\n  static addSupport() {\n    three_nebula_src_core_constants__WEBPACK_IMPORTED_MODULE_1__[\"SUPPORTED_JSON_BEHAVIOUR_TYPES\"].push(this.TYPE);\n  }\n\n  reset(colors, life, easing) {\n    this.initCanvas(colors);\n    life && super.reset(life, easing);\n  }\n\n  initCanvas(colors) {\n    this.gradientCanvas = {\n      canvas: document.createElement(\"canvas\")\n    };\n    const canvas = this.gradientCanvas.canvas;\n    canvas.width = 256;\n    canvas.height = 1;\n    const g = canvas.getContext(\"2d\");\n    const gradient = g.createLinearGradient(0, canvas.height, canvas.width, canvas.height);\n    colors.forEach(color => {\n      gradient.addColorStop(color.offset, color.color);\n    });\n    g.fillStyle = gradient;\n    g.fillRect(0, 0, canvas.width, canvas.height);\n    this.gradientCanvas.buffer = g.getImageData(0, 0, canvas.width, canvas.height).data;\n  }\n\n  initialize(particle) {\n    particle.transform.gradientCanvas = this.gradientCanvas;\n    particle.useColor = true;\n    particle.useAlpha = true;\n  }\n\n  mutate(particle, time, index) {\n    // @ts-ignore\n    this.energize(particle, time);\n    _ColorCanvas__WEBPACK_IMPORTED_MODULE_3__[\"ColorCanvas\"].updateParticleColor(particle, particle.transform.gradientCanvas, // @ts-ignore\n    this.energy);\n  }\n  /**\n   * Creates a GradientColor behaviour from JSON.\n   * @param json\n   */\n\n\n  static fromJSON(json) {\n    const {\n      colors,\n      life,\n      easing,\n      isEnabled = true\n    } = json;\n    return new GradientColor(colors, life, Object(three_nebula_src_ease__WEBPACK_IMPORTED_MODULE_2__[\"getEasingByName\"])(easing), isEnabled);\n  }\n\n}\nGradientColor.TYPE = \"GradientColor\";\n\n//# sourceURL=webpack:///./esm/GradientColor.js?");
